...
exec __INSTALL_ROOT__/opt/app/aft/scldlrm/bin/lrmcli -kill -name ${groupId}.${artifactId} -version __MAJOR_VERSION__.__MINOR_VERSION__.__PATCH_VERSION__ -routeoffer __SCLD_ROUTE_OFFER__
