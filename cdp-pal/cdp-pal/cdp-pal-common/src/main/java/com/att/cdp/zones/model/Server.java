...
public class Server extends ModelObject {
    ...
    /**
     * A simple note about the VM. 
     * This can be a list of MOTSIDS, an application name, or anything else deemed necessary.
     * @since 7/17/2017
     * @author ts4124
     */
    ...
    /**
     * JavaBean accessor to obtain the OS Type 
     * 
     * @return the image value
     */
    public String getOsType()
    {
    	return image==null?null:image.getOsType();
    }
