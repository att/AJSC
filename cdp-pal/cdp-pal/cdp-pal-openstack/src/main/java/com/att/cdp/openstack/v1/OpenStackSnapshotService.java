...
public class OpenStackSnapshotService extends AbstractSnapshot {
     ...
     */
    protected NovaConnector nova;

    /**
     * The URL to the nova service
     */
    protected String novaUrl;

    /**
     * Create the V1.0 snapshot service. This service uses the Nova (compute) service since this version of OpenStack
     * does not define the break-out to the Cinder service yet.
     * 
     * @param context
