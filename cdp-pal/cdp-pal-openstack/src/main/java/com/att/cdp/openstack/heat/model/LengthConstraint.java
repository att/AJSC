...
public class LengthConstraint extends Constraint implements Cloneable {
    ...
    /**
     * Construct the length constraint with initial values
     * 
     * @param min
     *            The minimum length
     * @param max
     ...
     *            A description
     */
    public LengthConstraint(Scalar min, Scalar max, Scalar description) {
        super(description);
        this.min = min;
        this.max = max;
    }
