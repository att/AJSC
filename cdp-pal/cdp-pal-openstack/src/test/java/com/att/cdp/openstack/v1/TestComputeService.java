...
public class TestComputeService extends AbstractTestCase {
    ...
    public void testAttachAndDetachPorts() throws ZoneException {
        ...
        /*
         * Get a list of servers. Make sure that at least one server exists. We'll just use the first one we find.
         */
        ...
        /*
         * Now, get the ports attached to that server. Make sure there is at least one port. We'll use the first one we
         * find.
         */
        ...
        /*
         * Use the first port to model the creation of a new port. We'll use the same subnet.
         */
        ...
        /*
         * Save the new port's ID. We'll use that to test that it was actually attached and detached
         */
        String id = newPort.getId();

        /*
         * Attach the port to the server. Then list all the ports and make sure the new port is included
         */
    ...
    public void testDeletePort() throws ZoneException {
        String[] ids =
            {
                "0e1ae02a-f34e-4208-a031-ba251c9d6538", "7235a241-a5d1-473c-97e2-f3115e91d878",
                "791b9689-7f19-469a-9759-154018315d4b", "958bbf73-7559-439d-bbad-94e67fc07263",
                "b43449bc-a427-4838-a0ab-4fd544533677", "b94deec4-fdcc-41d9-ae93-8d0f746011d2"
            };
