...
public class ContextClosedException extends ZoneException {
     ...
     */
    public ContextClosedException(String message) {
        super(message);
    }
     ...
     */
    public ContextClosedException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *            and indicates that the cause is nonexistent or unknown.)
     */
    public ContextClosedException(Throwable cause) {
        super(cause);
    }
}
